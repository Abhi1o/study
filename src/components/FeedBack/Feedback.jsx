                    ...
                    <div className="feedback-container">
                        <div className="feedback-card">
                            <div className="feedback-card-header">
                                <img src="https://metaschool.so/_next/static/media/user1.9704bef3.webp" alt="not found" className="feedback-profile-image" />
                            ...
                            <img src="https://metaschool.so/_next/static/media/stars.7de57f34.svg" alt="star not found" className="feedback-star" />
                            ...
                            <div className="feedback-placed-company">
                                <span>Placed at</span>
                                <img src="https://assets.nextleap.app/images/ola_pdf_company.png" alt="company not found" className="feedback-placed-company-img" />
                            </div>
                        </div>
                        <div className="feedback-card">
                            <div className="feedback-card-header">
